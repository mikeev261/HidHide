...
export type Snapshot = {profiles:CatalogProfile[]; settings:Settings; settingsVersion:Version|null; activeId:string; verified:boolean; status:string; conflict:boolean; launchedId?:string; repositoryIssues:(string|{file:string;message:string})[]; deviceError?:string; adoptionAwaitingSave?:boolean; adoptedSettings?:Settings|null; devices:Device[]};
