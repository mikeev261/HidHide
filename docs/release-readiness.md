...
| Missing/damaged driver repair, unknown newer driver preservation | 153 driver and 97 controller checks passed after repair implementation; isolated validation open |
| Cancellation before/after legacy removal, interrupted recovery, power loss | Conservative journal exists; complete recovery UX and isolated matrix open |
...
| Profiles, baseline overlap, persistent disable, external-edit conflict | 90 C++ tests and earlier probes; final installed semantics validation open |
