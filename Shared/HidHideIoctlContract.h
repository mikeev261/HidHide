...
#define IOCTL_GET_APP_PROFILES        CTL_CODE(IoControlDeviceType, 2058, METHOD_BUFFERED, FILE_READ_DATA)
#define IOCTL_SET_APP_PROFILES        CTL_CODE(IoControlDeviceType, 2059, METHOD_BUFFERED, FILE_READ_DATA)
