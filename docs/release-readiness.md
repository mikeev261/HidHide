...
|---|---|
| One public MSI, standard WiX dialogs, visible HidHide Profiles entry, UI shortcut | 2.1.8 structural CI; real clean-host validation pending |
...
| Optional owned-code/MSI signing and unsigned mode | Optional signing implemented, certificate path untested; deliver explicitly unsigned |
...
| Product/actual-driver version, missing/reboot diagnostics, credits | About visually verified; modal-maintenance rejection and normal exit regression passed |
